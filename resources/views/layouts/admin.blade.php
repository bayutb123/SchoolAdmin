...
<head>
    ...
    <meta name="description" content="School Inventory System">
...
<body id="page-top">
    ...
    <script type="module" src="https://cdn.jsdelivr.net/npm/bootstrap-select@1.14.0-beta2/dist/js/bootstrap-select.min.js">
    </script>
